...
BOOST_PYTHON_MODULE(Core)
{
    ...
    class_<L3::SE3, boost::shared_ptr<L3::SE3> >( "SE3" );

    class_<L3::SlidingWindow<L3::SE3>, boost::shared_ptr< L3::SlidingWindow<L3::SE3> >, boost::noncopyable >( "SlidingWindow", init<std::string,double>() );

    //class_< L3::ConstantTimeIterator<L3::SE3>, boost::shared_ptr< L3::ConstantTimeIterator<L3::SE3> > > >( "ConstantTimeIterator", init< boost::shared_ptr< L3::SlidingWindow<L3::SE3> > >());
